...
//   context.require_write_lock( config::eosio_auth_scope );
   ...
   check_account_mutable(context, remove.account); // UX Network
...
//   context.require_write_lock( config::eosio_auth_scope );
   ...
   try {
      ...
      check_account_mutable(context, requirement.account); // UX Network
...
//   context.require_write_lock( config::eosio_auth_scope );
   ...
   check_account_mutable(context, unlink.account); // UX Network
